...
cmake -DONUT_USE_OPENGL=ON -DONUT_BUILD_SAMPLES=ON -DONUT_USE_HUNTER=OFF -DONUT_BUILD_STANDALONE=ON -DONUT_BUILD_UI_EDITOR=ON -DCMAKE_BUILD_TYPE=Release -DBUILD_SHARED_LIBS=OFF ../onut/
